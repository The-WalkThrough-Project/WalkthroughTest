...
class CadastroHF extends StatefulWidget {
  final String lab;

  const CadastroHF({Key? key, required this.lab}) : super(key: key);

  @override
  State<CadastroHF> createState() => _CadastroHFState();
}

class _CadastroHFState extends State<CadastroHF> {
              ...
              ElevatedButton(
                  ...
                  onPressed: () async {
                    if (await confirm(
                      ...
                      content: const Text(
                        'Você tem certeza de que deseja cadastrar este horário?',
                        style: TextStyle(color: Colors.deepPurple),
                      ),
                      textOK: const Text(
                        'Sim',
