...
class TabelaHorarios extends StatefulWidget {
  ...
  final List<HorarioFixo> horarios;
...
class _TabelaHorariosState extends State<TabelaHorarios> {
  ...
  HorarioFixo retornaHorarios(String horarioT, String diaSemana, String lab){
    for(HorarioFixo horario in widget.horarios){
        if(horario.horario == horarioT && horario.diaSemana == diaSemana){
  ...
  int primeiroOuSegundoHorariodeTarde(String diaSemana){
    for(HorarioFixo horario in widget.horarios){
        if(horario.horario == "3T4T" && horario.diaSemana == diaSemana){
          return 1;
        } else if(horario.horario == "4T5T" && horario.diaSemana == diaSemana){
          return 2;
        } 
    }
    return 0;
              ...
              Container(
                ...
                child: titulo(
                  widget.diaSemana.contains("segunda") ? "SEGUNDA-FEIRA" : 
                    widget.diaSemana.contains("terca") ? "TERÇA-FEIRA" :
